...
import com.example.assignmentview.util.extension.lazyThreadSafetyNone
...
abstract class BaseActivity<VM : BaseViewModel, B : ViewDataBinding> : AppCompatActivity() {
    ...
    protected val viewModel: VM by lazy { ViewModelProvider(this)[persistentViewModelClass] }
}